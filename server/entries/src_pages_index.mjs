...
function Page() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "landing", children: [
      /* @__PURE__ */ jsxs("h1", { className: "landing-hook", children: [
        "Find your perfect ",
        /* @__PURE__ */ jsx("br", {}),
        "domain",
        /* @__PURE__ */ jsx("span", { className: "boxed-text", children: /* @__PURE__ */ jsx("span", { className: "highlight-text", children: "in seconds" }) })
      ] }),
      /* @__PURE__ */ jsx("h2", { className: "landing-description", children: "Our AI rapidly searches thousands of domain names to help you secure the best available option." })
    ] }),
    /* @__PURE__ */ jsx("div", { style: { height: "2000px" } })
  ] });
}
...
const configValuesSerialized = {
  ...
  ["Page"]: {
    type: "standard",
    definedAtData: { "filePathToShowToUser": "/src/pages/index/+Page.jsx", "fileExportPathToShowToUser": [] },
    valueSerialized: {
      type: "plus-file",
